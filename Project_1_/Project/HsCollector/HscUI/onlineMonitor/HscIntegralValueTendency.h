#ifndef HSCINTEGRALVALUETENDENCY_H
#define HSCINTEGRALVALUETENDENCY_H
...
namespace Ui {
class HscIntegralValueTendency;
}

class HscIntegralValueTendency : public QWidget
{
    Q_OBJECT

    friend class HscOnlineMonitor;
public:
    explicit HscIntegralValueTendency(QWidget *parent = nullptr);
    ~HscIntegralValueTendency();
...
private:
    Ui::HscIntegralValueTendency *ui;
...
#endif // HSCINTEGRALVALUETENDENCY_H
